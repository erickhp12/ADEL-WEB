...
import { getSpecialtyCategories } from '../../../services/service_categories'
...
export default class extends React.Component{
    ...
    async componentDidMount() {
        ...
        try {
            const req = await getSpecialtyCategories({ limit: this.state.page_limit})
    ...
    render(){
        const breadcrumb = [
            ...
            { name: "Especialidades", url: "", active: true }
        ]
        return (
            <Layout title="Especialidades" selectedMenu="services" breadcrumb={ breadcrumb }>
                <div className="card">
                    <div className="card-content">

                        <div className='columns tabs is-small'>
                            <ul id="tabs">
                                <li className={`column is-6 ${this.state.selected_tab == "1" && 'is-active'}`} onClick={(e) => this.clickInTab(1)}><a><h4 className="subtitle is-4">Especialidades</h4></a></li>
                                <li className={`column is-6 ${this.state.selected_tab == "2" && 'is-active'}`} onClick={(e) => this.clickInTab(2)}><a><h4 className="subtitle is-4">Categorias</h4></a></li>
                            </ul>
                        </div>
